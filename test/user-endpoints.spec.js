    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "caineal", translation: "cinnamon" },
            { original: "halò", translation: "hello" },
            { original: "taigh", translation: "house" },
            { original: "leasaichear", translation: "developer" },
            { original: "Alba", translation: "Scotland" },
            { original: "iongantach", translation: "Amazing" },
            { original: "cù", translation: "dog" },
            { original: "luch", translation: "mouse" },
          ],
        };
